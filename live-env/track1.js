stack(
    ...
    // Acid Bass Rewrite
    note(`
        [a1 ~ a1 b1] [~ a1 c1 a1] [~ a1 a1 ~] [a1 a1 ~ c1]
        [a1 ~ b1 ~] [c1 ~ a1 ~] [a1 ~ ~ a1] [c1 ~ b1 ~]
        [a1 ~ ~ b1] [~ a1 c1 ~] [~ a1 a1 ~] [b1 a1 ~ c1]
        [a1 ~ b1 a1] [c1 ~ a1 ~] [a1 ~ a1 a1] [c1 ~ b1 ~]
        [a1 ~ a1 b1] [~ c1 ~ a1] [~ a1 a1 ~] [b1 ~ c1 ~]
        [~ a1 ~ a1] [c1 ~ ~ a1] [a1 ~ a1 a1] [c1 b1 ~ ~]
        [a1 a1 ~ b1] [~ a1 c1 ~] [~ a1 a1 ~] [b1 a1 ~ c1]
        [a1 ~ b1 a1] [c1 ~ a1 ~] [a1 ~ ~ a1] [c1 ~ b1 a1]
    `)
        .s("sawtooth")
        .slow(8)
        // Acid Filter
        ...
        //.swingBy(16, 0.1)
        .distort("2.5:0.6")
        .orbit(2).compressor("-20:20:10:.002:.1").lpf(1500).postgain(0.8),     // Post-distortion filter on separate orbit (2)

    // crushed kicks, snares, and hats
    stack(
...
//.orbit(1).hpf(2000).room(0.9).rsize(10)
